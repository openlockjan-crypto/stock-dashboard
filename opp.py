...
# --- 版本控制 ---
VERSION = "2.17-B (Form Input Mode - Fixed)"
...
with tab3:
    ...
    with col_list:
        ...
        if not current_df.empty:
            st.dataframe(
                current_df.style.format({'股數': '{:.3f}', '買進價': '${:.2f}'}),
